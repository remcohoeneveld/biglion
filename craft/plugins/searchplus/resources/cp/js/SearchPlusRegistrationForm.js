(function($){
    ...
    if (typeof Craft.SearchPlus === typeof undefined) {
        Craft.SearchPlus = {};
    }
     ...
     */
    Craft.SearchPlus.RegistrationForm = Craft.BaseElementIndex.extend({
        licenseKey: null,
        ...
        loadLicenseInfo: function(action) {
            Craft.postActionRequest('searchPlus/registration/getLicenseInfo', $.proxy(function(response, textStatus) {
        ...
        handleUnregisterLicenseFormSubmit: function(ev) {
            ...
            Craft.postActionRequest('searchPlus/registration/unregister', $.proxy(function(response, textStatus) {
        ...
        handleUpdateLicenseFormSubmit: function(ev) {
            ...
            Craft.postActionRequest('searchPlus/registration/updateLicenseKey', data, $.proxy(function(response, textStatus) {
        ...
        handleTransferLicenseFormSubmit: function(ev) {
            ...
            Craft.postActionRequest('searchPlus/registration/transfer', $.proxy(function(response, textStatus) {
